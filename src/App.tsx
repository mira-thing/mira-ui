...
function AppContent() {
  ...
  const openConsent = useCallback(() => openOverlay('consent'), [openOverlay])
  const openSponsor = useCallback(() => openOverlay('sponsor'), [openOverlay])
  const openUpdateCard = useCallback(() => openOverlay('updateCard'), [openOverlay])
  const closeUpdateCard = useCallback(() => closeOverlay('updateCard'), [closeOverlay])
  const closeConsent = useCallback(() => closeOverlay('consent'), [closeOverlay])
